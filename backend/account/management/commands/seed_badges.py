...
BADGES = [
    ...
    # --- Streaks ---
    {
        "code": "streak_7",
        "name": "Week Warrior",
        "description": "Maintained a 7-day usage streak without missing a day.",
        "icon": "🔥",
        "category": "Streak",
    },
    {
        "code": "streak_10",
        "name": "10-Day Hustler",
        "description": "Kept the momentum going with a 10-day usage streak.",
        "icon": "❤️",
        "category": "Streak",
    },
    {
        "code": "streak_30",
        "name": "Monthly Legend",
        "description": "Incredible! You maintained a 30-day unbroken usage streak.",
        "icon": "🏅",
        "category": "Streak",
    },
    {
        ...
        "description": "An extraordinary 100-day usage streak. You are truly unstoppable.",
        "icon": "🌟",
        "category": "Streak",
    },
    # --- Likes Received ---
